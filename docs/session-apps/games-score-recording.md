---
title: "Games Score Recording"
description: "The game score recording app on DailyPB allows players to log their game scores, track detailed statistics, and optionally upload their games to DUPR. I..."
keywords: ["pickleball", "DailyPB", "pickleball sessions", "pickleball events", "pickleball signup", "pickleball scheduling", "open play pickleball", "DUPR pickleball", "DUPR rating", "pickleball rating", "pickleball score", "game scores", "pickleball results", "pickleball ladder", "round robin pickleball", "ladder app"]
---
...
![chrome_2Fd2q3OlsW.gif](/img/notion-help/games-score-recording/chrome-2fd2q3olsw.gif)
...
![Example URL that can be shared by other players. ](/img/notion-help/games-score-recording/image.png)
...
If you select “Require box to record a game” and don’t have “allow players to create and edit boxes” then no one will be able to record a Game until a Host creates at least one Box. When this happens, the 24 hour [Reminder](/help/sessions/2-24-hr-reminders) email to Hosts will include this warning.
...
![chrome_vQoD1a54L4.gif](/img/notion-help/games-score-recording/chrome-vqod1a54l4.gif)
...
![chrome_5eGCTcEcmO.gif](/img/notion-help/games-score-recording/chrome-5egctcecmo.gif)

### Deleting a Box

Simply find the Box you wish to delete and click the “Delete” button to remove it. 

![chrome_cM1yuJ7iJi.gif](/img/notion-help/games-score-recording/chrome-cm1yuj7iji.gif)
...
![Primary (Win-loss) and Secondary (Average Differential) sorting methods.](/img/notion-help/games-score-recording/image-1.png)
...
![View of Secondary sort menu.](/img/notion-help/games-score-recording/image-2.png)
...
![image.png](/img/notion-help/games-score-recording/image-3.png)
...
![image.png](/img/notion-help/games-score-recording/image-4.png)
...
![image.png](/img/notion-help/games-score-recording/image-5.png)
...
2. Click on the two Players making up a team. Then click on the two Players making up the other team.  You will notice the slot highlighted for each Player.
    ...
    ![chrome_krfVuRCV2P.gif](/img/notion-help/games-score-recording/chrome-krfvurcv2p.gif)
    
3. Enter the score for the first team (blue background), then enter the score for the second team (orange background).
    
    ![chrome_BJoUN68Tgr.gif](/img/notion-help/games-score-recording/chrome-bjoun68tgr.gif)
    
4. Optional, if you are using Boxes select the Box from the dropdown. 

![image.png](/img/notion-help/games-score-recording/image-6.png)
...
![chrome_3bw4jv4gf7.gif](/img/notion-help/games-score-recording/chrome-3bw4jv4gf7.gif)
...
![image.png](/img/notion-help/games-score-recording/image-7.png)
...
Clicking this button will download a spreadsheet (CSV format) to your device. However you will need to make one small change to the CSV file before uploading to the DUPR website. Here are the [instructions for DUPR Uploading.](/help/session-apps/dupr-games)